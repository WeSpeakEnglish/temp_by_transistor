...
void loop() {
    ...
    // Start conversion with strong pull-up for parasitic power
    ow_reset();
    ...
    Serial.print("[DATA]  "); print_hex(scratch,9);

    if(crc8(scratch,9)!=0) { Serial.println("  CRC FAIL"); delay(2000); return; }

    // Decode temperature (12-bit signed, 0.0625°C/LSB)
